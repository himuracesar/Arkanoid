...
class Explosion
{
    private:
        ...
        GLfloat static colorsGREEN[MAX_COLORS][3];
        GLfloat static colorsRED[MAX_COLORS][3];
        GLfloat static colorsBLUE[MAX_COLORS][3];
        GLfloat static colorsYELLOW[MAX_COLORS][3];
    ...
    public:
        Explosion(double x, double y, int color);//, int size, int numParticles);
        ~Explosion();
        void update();
        void render();
        bool isDead();
